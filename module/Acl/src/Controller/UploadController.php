...
class UploadController extends AbstractActionController
{
	...
	// 	readfile($file);
	// }
	private function __file($filePath, $description) {
		if (file_exists($filePath)) {
			// Get the file extension to set the appropriate headers
			...
			switch ($extension) {
				...
				case 'pdf':
					...
					break;
				default:
					$mimeType = 'application/octet-stream'; // For unknown types
			}
