...
{
	protected $table = 'hr_training'; //tablename
	...
	{  
	    ...
	    $select->from(array('t' => $this->table))
	           ->join(array('e' => 'hr_employee'), 'e.id = t.employee', array('full_name', 'emp_id', 'employee_id'=>'id'));
	...
	public function get($param)
	{
		...
		$select = $sql->select();
		$select->from(array('t' => $this->table))
		      ->join(array('e' => 'hr_employee'), 'e.id = t.employee', array('employee' => 'full_name', 'employee_id' => 'id'))
		       ->where($where);
