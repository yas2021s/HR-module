...
class ClaimSubheadTable extends AbstractTableGateway 
{
	protected $table = 'hr_claim_subheads'; //tablename
	...
	*/
	...
	{	
		...
		$select = $sql->select();
		$con = array(
					'id','date','ta','estimated_expense','advance','employee','actual_expense','amount_claim','status','author','created','modified',
	 ...
	 * @return String | Int
	 */
	public function getLastNo($ta_no)
	{
		$adapter = $this->adapter;
		$sql = new Sql($adapter);
		$select = $sql->select();
