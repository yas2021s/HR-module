...
class PitVoucherTable extends AbstractTableGateway 
{
	protected $table = 'hr_pit_voucher'; //tablename
	...
	*/
	...
	{	
		...
		$select = $sql->select();
		$con = array(
					'id','date','type','voucher','author','created','modified',
	 ...
	 * @return Array
	 */	
	public function getDateWiseDay($start_date, $end_date,$where=NULL)
	{	
		$adapter = $this->adapter;
		$sql = new Sql($adapter);
		$select = $sql->select();
