		...
		if($this->getRequest()->isPost()):		
		   ...
		   $yearMonth=$form['year'].'-'.$form['month'];
			...
			$client->setMethod('POST');
				...
				// $client->setUri('http://localhost/HR/public/pr/commitpayroll');
				// $client->setHeaders([
				// 	'Content-Type' => 'application/json',
				// 	'Cookie' => 'BhutanPostSession=fu5r2ks9l36ls94qe8sl54cf2j',
				// ]);
				...
				// } else {
				// 	throw new \Exception("Failed to commit payroll to HR API.");
				// }
