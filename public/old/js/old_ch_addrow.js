...
(function ($){
	...
	$.fn.porder = function (spec){
		...
		$("#addRow").click(function(){
			po_addrow(parentObj, options.getUom, options.getUomChange);			     
		});	
		po_calculation(parentObj);			
	};	
	function po_addrow(obj, getUom, getUomChange){
	...
	$.fn.preceipt = function (spec){
		...
		$("#addRow").click(function(){
			pr_addrow(parentObj,options.getUom,options.getUomChange);			     
		});	
		pr_calculation(parentObj);	
	};    
	function pr_addrow(obj,getUom,getUomChange){
		var lastRow = obj.find("tbody tr:last").attr('id');
		var tmplt_row = obj.find("tbody tr:last").clone(true);
		clone = tmplt_row.clone();
...
/*##################################################################
  ...
  ##################################################################*/
	 ...
	 */
		...
		$("#addRow").click(function(){
			sam_addrow(parentObj, options.getDetails);			     
		});				
	};	
	function sam_addrow(obj, getDetails){
		var lastRow = obj.find("tbody tr:last").attr('id');
		var tmplt_row = obj.find("tbody tr:last").clone(true);
		clone = tmplt_row.clone();
		clone.find('div.chosen-container').each(function(){
